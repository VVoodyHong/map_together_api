...
public enum StatusCode {
    ...
    ,CODE_757(757, "장소 인덱스가 존재하지 않습니다.")
    ,CODE_758(758, "댓글 내용을 입력해주세요.")
    ,CODE_759(759, "장소 게시물 인덱스가 존재하지 않습니다.")
    ,CODE_760(760, "장소 게시물의 댓글 인덱스가 존재하지 않습니다.")
    ,CODE_761(761, "검색어를 입력해주세요.")
